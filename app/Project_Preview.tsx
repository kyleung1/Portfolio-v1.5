      ...
      <div>
        ...
        <div className="flex justify-center">
          <div className='flex flex-wrap gap-10 justify-center my-20 w-3/4'>
            <div className='bg-indigo-300  xl:w-[500px] lg:w-[250px] md:w-[200px] xl:h-[500px] lg:h-[250px] md:h-[200px] p-5' data-aos="fade-right" data-aos-duration="1500">
            ...
            <div className='bg-indigo-300  xl:w-[500px] lg:w-[250px] md:w-[200px] xl:h-[500px] lg:h-[250px] md:h-[200px] p-5' data-aos="fade-right" data-aos-duration="1000">
            ...
            <div className='bg-indigo-300  xl:w-[500px] lg:w-[250px] md:w-[200px] xl:h-[500px] lg:h-[250px] md:h-[200px] p-5' data-aos="fade-right" data-aos-duration="500">
